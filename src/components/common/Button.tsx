...
export const Button: React.FC<ButtonProps> = ({
  ...
  const variantStyles = {
    ...
    secondary:
      'bg-[var(--bg-surface-hover)] hover:bg-[var(--border-main)] text-[var(--text-primary)] focus:ring-[var(--border-strong)]',
    outline:
      'border border-[var(--border-strong)] bg-transparent hover:bg-[var(--bg-surface-hover)] text-[var(--text-primary)] focus:ring-[var(--border-strong)]',
